  ...
  "home": {
    ...
    "features": {
      ...
      "items": {
        ...
        "skills": {
          "title": "Открытый исходный код & Расширяемость",
          "description": "Apache 2.0, открытый исходный код. 70 встроенных навыков + 5 700+ навыков сообщества — добавляйте или создавайте свои. Изучайте, изменяйте и настраивайте код самостоятельно."
        },
        "discord": {
          "title": "Всегда с вами",
        ...
        "vision": {
          "title": "Неизменяемая игровая ОС + ИИ",
          "description": "Построена на Bazzite — неизменяемой ОС, которая никогда не ломается. Полноценный Steam/Proton-гейминг из коробки. На этом безопасном и мощном игровом Linux живет ваш собственный ИИ. Будущее: пойте, играйте и творите с вашим ИИ, вплоть до Physical AI."
        }
      }
    },
    "comparison": {
